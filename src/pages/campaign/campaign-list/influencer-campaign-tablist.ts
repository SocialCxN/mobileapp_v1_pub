...
@Component({
  ...
  templateUrl: 'influencer-campaign-tablist.html'
})
export class InfluencerCampaignTabListPage {
  role: string;
  currentURL: string;
  start: Boolean = true;
  ...
  constructor(private _authService: AuthProvider,private _campaign: CampaignService,private _notificationService: NotificationService,
